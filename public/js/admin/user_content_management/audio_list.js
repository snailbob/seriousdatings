                ...
                if (result) {
                    $.ajax({
                        ...
                        success: function (value) {
                            ...
                            toastr.info("Request music is rejected");
                        },
                ...
                if (result) {
                    $.ajax({
                        ...
                        success: function (value) {
                            ...
                            toastr.info("Request music is approved");
                        },
                        error: function (data, a, b) {
                            console.log(data, a, b);
                        }
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
                        url: base_url + '/deleteUserMusic',
                        data: data,
                        cache: false,
                        success: function (value) {
                            console.log(value);
                            $('td#' + value.id).parent().remove();
                            toastr.info("Request music is successfully deleted");
                        },
                        error: function (data, a, b) {
                            console.log(data, a, b);
                        }
