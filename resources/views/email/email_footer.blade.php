                                ...
                                <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:180%;color:#555555; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 30px;">
                                                <div style="font-size:12px;line-height:22px;color:#555555;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                    <p style="margin: 0;font-size: 12px;line-height: 22px">
                                                        <span style="font-size: 14px; line-height: 25px;">Cheers,</span>
                                                    </p>
                                                    <p style="margin: 0;font-size: 12px;line-height: 22px">
                                                        <em>
                                                            <strong>
                                                                <span style="font-size: 14px; line-height: 25px;">Serious Datings Team</span>
                                                            </strong>
                                                        </em>
                                                    </p>
                                                </div>
                    ...
                    <div style="background-color:transparent;">
                        <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #BBBBBB;"
                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#BBBBBB;">
                                ...
                                <div class="col num4" style="max-width: 100%;min-width: 200px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                            <!--<![endif]-->
                                            ...
                                            <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:120%;color:#FFFFFF; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                                <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                    <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                        <span style="font-size: 14px; line-height: 16px;">
                                                            <strong>support@seriousdatings.com</strong>
                                                        </span>
                                                        <br>
                                                    </p>
                                                    <p style="margin: 0; margin-top: 16px;font-size: 8px;line-height: 12px; text-align: center">
                                                        <span style="font-size: 14px; line-height: 25px;">&copy; 2017
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
