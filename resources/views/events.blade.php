...
<div class="inner-header calendar-event-banner">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h1>
          <!--<i class="calendar-event-icon"><img src="public/images/calendar-event-icon.png"  alt=""></i>-->Calendar of Event</h1>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="left-section">
          <div class="left-section-inner">
            ...
            <div class="age-grouph">
              <ul>
                @if(count($events['eventCategory']) > 0) @foreach($events["eventCategory"] as $event)
                <li>
...
<script>
  var calendar_events = '{!! $events["encodedEvents"] !!}';
</script>
