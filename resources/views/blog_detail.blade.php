...
<div class="container">
  ...
  <div class="row">
   ...
   <h3>community for singles looking for love, relationships, friendship and dates</h3>
   <label><span>By Mariya / May 30,2017</span> <ul><li><a href=""><i class="fa fa-comment-o"></i> (6)</a></li> <li><a href=""><i class="fa fa-heart-o"></i> (106)</a></li></ul></label>
   
   <img src="images/Beautiful-stylish-girl-goggles-wear.jpg">
   ...
   <p>Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.com has built the largest community for singles looking for love, relationships, friendship and dates. Our mission is simple: Creating Relationships. Connecting Lives events.</p>
    <p>Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.com has built the largest community for singles looking for love, relationships, friendship and dates. Our mission is simple: Creating Relationships. Connecting Lives events.Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.com has built the largest community for singles looking for love, relationships, friendship and dates. Our mission is simple: Creating Relationships. Connecting Lives events.Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, <a href="">Seriousdatings.com</a> has built the largest community for singles looking for love, relationships, friendship and dates. Our mission is simple: Creating Relationships. Connecting Lives events.Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.com has built the largest community for singles looking for love, relationships, friendship and dates. Our mission is simple: Creating Relationships. Connecting Lives events.</p>
   ...
   <label class="leave_comment_box_heading">3 comments</label>
   
   <div class="leave_comment_box">
   <div class="leave_comment_box_left"><img src="images/default-user-image.png"></div>
   
   <div class="leave_comment_box_right"> <textarea></textarea> <button class="post">Post</button></div>
   
   </div>
   
   
   <div class="send_comment_outer">
   
   <div class="send_comment_left"><img src="images/Beautiful-stylish-girl-goggles-wear.jpg"></div>
   
   <div class="send_comment_right"><h3>Mariya <span>May 30,2017</span></h3> <p>Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.com has built the largest community for singles looking for love, relationships, friendship and dates</p>
   <ul><li><a href=""><i class="fa fa-reply"></i> (5) Reply</a></li> <li><a href=""><i class="fa fa-heart"></i> (5) Like</a></li></ul>
   ...
   <div class="send_comment_right"><h3>Mariya <span>May 30,2017</span></h3> <p>Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.</p>
   <ul><li><a href=""><i class="fa fa-reply"></i> Reply</a></li> <li><a href=""><i class="fa fa-heart"></i> Like</a></li></ul>
   
   
   <div class="send_comment_outer_rply">
   
   <div class="leave_comment_box_reply">
   <div class="leave_comment_box_left_reply"><img src="images/default-user-image.png"></div>
   
   <div class="leave_comment_box_right_reply"> <textarea></textarea> <button class="post">Post</button></div>
   
   </div>
   
   <div class="send_comment_left_rply"><img src="images/Beautiful-stylish-girl-goggles-wear.jpg"></div>
   
   <div class="send_comment_right_rply"><h3>Mariya <span>May 30,2017</span></h3> <p>Seriousdatings.com is a dating site for singles in the U.S. Founded in 2005, Seriousdatings.</p>
   <ul><li><a href=""><i class="fa fa-reply"></i> Reply</a></li> <li><a href=""><i class="fa fa-heart"></i> Like</a></li></ul>
   ...
   <ul><li><a href=""><i class="fa fa-reply"></i> Reply</a></li> <li><a href=""><i class="fa fa-heart"></i> Like</a></li></ul>
        ...
        <ul>
        <li><a href="">
    Seriousdatings.com is a dating site for singles in the U.S.
        
        </a></li>
        
        <li><a href="">
  If you have never experienced the power of internet dating you are missing out on an incredible opportunity
