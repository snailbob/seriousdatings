                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Gift Name<span
                                            class="symbol required"></span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Enter your Gift Name"
                                           name="name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Gift Price<span
                                            class="symbol required"></span></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" placeholder="Enter your gift price"
                                           name="price" required>
                                </div>
                            </div>
