                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($giftCards as $giftCard)
                                    <tr>
                                        ...
                                        <td>{{$giftCard->giftCategory['name']}}</td>
                                        <td>
                                            <div class="btn-group table-action custom"><a
                                                        class="btn btn-primary btn-sm dropdown-toggle"
                                                        data-toggle="dropdown"> <i class="fa fa-cogs"></i> Action <span
                                                            class="caret"></span> </a>
                                                <ul role="menu" class="dropdown-menu">
                                                    <li><a href='gift_cards/{!! $giftCard->id !!}/edit'> <i
