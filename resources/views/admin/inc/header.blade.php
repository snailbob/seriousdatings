            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ url('admin/events/create') }}"><i class="fa fa-circle-o"></i> Add New Event </a>
                        </li>
                        <li><a href="{{ url('admin/events/manage_eventtypes') }}"><i class="fa fa-circle-o"></i> Manage
                                Event Types </a></li>
                        <li><a href="{{ url('admin/events/addEventType') }}"><i class="fa fa-circle-o"></i> Add Event
                                Type </a></li>
                    </ul>
                </li>
