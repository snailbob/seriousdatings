...
@section('form_area')
    ...
    <div class="middle inner-middle">
        <div class="inner-header travel-banner">
            <div class="container">
                <h1><i class="calendar-event-icon"><img src="images/travel-icon.png"  alt=""></i>Serious Dating Travel</h1>
            </div>
        </div>
        <div class="inner-contendbg">
            <div class="left-section">
                ...
                <div class="ad-div"><a href="#"><img src="images/expert-ad.png"  alt=""></a></div>
                <div class="ad-div2"><a href="#"><img src="images/why-bokk.png"  alt=""></a></div>
            </div>
            <div class="right-content-section">
                <div class="serious-banner"><a href="#"><img src="images/banner-img1.jpg" alt=""></a></div>
                <div class="cracking-offer"><a href="#"><img src="images/ad-banner.png"  alt=""></a></div>
                <div class="dis-dating-outer">
                    <div class="last-min-save">
                        ...
                        <a href="#"><img src="images/watch-icon.png"  alt=""></a>
                    </div>
                    <div class="discount-right">
                        <h2>Bia Discount With Our Brand New Coupons</h2>
                        <img src="images/coupan-img.jpg"  alt=""></div>
                </div>
                <div class="feature-destination">
                    <h2>Feature Destination</h2>
                    <div class="destination-cols"><a href="#"><img src="images/new-york.jpg" alt=""><span>New York</span></a></div>
                    <div class="destination-cols"><a href="#"><img src="images/miami.jpg" alt=""><span>Miami</span></a></div>
                    <div class="destination-cols"><a href="#"><img src="images/orland.jpg" alt=""><span>Orland</span></a></div>
                    <div class="destination-cols"><a href="#"><img src="images/las-vegas.jpg" alt=""><span>Las Vegas</span></a></div>
                </div>
            </div>
        </div>
    </div>
