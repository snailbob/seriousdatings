...
<div ng-controller="profileSettingsController" ng-cloak>
            ...
            <div class="row">
                <div class="col-sm-3 crop-col" ng-show="!imgDone.done">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="cropArea">
                                <ui-cropper image="myImage" result-image="logged_user_info.photo" on-load-done="imgEdit = false" result-image-quality="0.5" area-type="square"></ui-cropper>
                            </div>
                            <div>
                                <div class="hidden">
                ...
                <div class="col-sm-3 text-center crop-col" ng-if="imgDone.done">
                    <div>
                        <img class="img-thumbnail img-responsive" ng-src="@{{logged_user_info.photo}}" />
                    </div>
                    ...
                    <div class="row profile-img-styling">
                        ...
                        <div class="col-xs-4 img-blocks">
                            ...
                            <div class="images-style-bg full-radius">
                                ...
                                <img alt="your image" ng-src="@{{logged_user_info.photo}}" id="my picture">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="firstName" ng-model="logged_user_info.firstName" placeholder="First Name" required/>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="">Last Name</label>
                                            <input type="text" class="form-control" name="lastName" ng-model="logged_user_info.lastName" placeholder="Last Name" required />
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="birthdate" ng-model="logged_user_info.birthdateObj" ng-attr-max="@{{calendarMaxDate()}}"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-number" type="text" name="zipcode" ng-model="logged_user_info.zipcode" placeholder="ZipCode"
                                                required/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required name="gender" ng-model="logged_user_info.gender" id="gender">
                                    ...
                                    {{--  <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" name="password" ng-model="logged_user_info.password" id="password_orig" placeholder="Password"
                                                required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" name="password2" ng-model="logged_user_info.password2" placeholder="Confirm Password" required
                                            />
                                        </div>
                                    </div>  --}}
                                </div>
                            ...
                            <div class="row single-line-label">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="relationshipGoal" ng-model="logged_user_info.relationshipGoal">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="income" ng-model="logged_user_info.income">
                                            <option value="">--Select--</option>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="haveChildren" ng-model="logged_user_info.haveChildren">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="doYouOwnACar" ng-model="logged_user_info.doYouOwnACar">
                                            <option value="">--Select--</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="areYouOnAnyMedication" ng-model="logged_user_info.areYouOnAnyMedication">
                                            <option value="">--Select--</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="whatIsTheLongestRelationshipYouHaveBeenIn" ng-model="logged_user_info.whatIsTheLongestRelationshipYouHaveBeenIn">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="partnerDependability" ng-model="logged_user_info.partnerDependability">
                                            <option value="">--Select--</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="sexualCompatibility" ng-model="logged_user_info.sexualCompatibility">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="friendshipBetweenPartners" ng-model="logged_user_info.friendshipBetweenPartners">
                                            <option value="">--Select--</option>
                                            <option value="Very Important">Very Important</option>
                                            <option value="Important">Important</option>
                                            <option value="Somewhat Important">Somewhat Important</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="drugs" ng-model="logged_user_info.drugs">
                                            <option value="">--Select--</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                            <option value="Sometime">Sometime</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="hairColor" ng-model="logged_user_info.hairColor">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="hairStyle" ng-model="logged_user_info.hairStyle">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="eyeColor" ng-model="logged_user_info.eyeColor">
                                            <option value="">--Select--</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="height" ng-model="logged_user_info.height">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="bodyType" ng-model="logged_user_info.bodyType">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="zodicSign" ng-model="logged_user_info.zodicSign">
                                            <option value="">--Select--</option>
                                            <option value="Aries">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="smoke" ng-model="logged_user_info.smoke">
                                            <option value="">--Select--</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="drink" ng-model="logged_user_info.drink">
                                            <option value="">--Select--</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="excercise" ng-model="logged_user_info.excercise">
                                            <option value="">--Select--</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="excerciseSchedule" ng-model="logged_user_info.excerciseSchedule">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="educationLevel" ng-model="logged_user_info.educationLevel">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="language" ng-model="logged_user_info.language">
                                            <option value="">--Select--</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="ethnicity" ng-model="logged_user_info.ethnicity">
                                            <option value="">--Select--</option>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="list-group">
                            <a href="{{url().'/users/'.Auth::user()->username.'/about_your_date'}}" class="list-group-item">
                                <i class="fa fa-fw fa-calendar" aria-hidden="true"></i> Update About My Date
                            </a>
