                            ...
                            <div class="col-md-12">
                                <div>
                                    <h3 style="color: #FFF; background: #E21D24;font-weight: 600;font-size: 22px;width: 100%;padding:6px 10px;margin:0; line-height:28px;">
                                        ...
                                        <a href="{!! url() !!}/profiles/groups/create"
                                           class="pull-right btn btn-danger btn-facebook btn-sm"
                                ...
                                @if(Auth::check())
                                    {{--@if($groups != null)--}}
                                        {{--@if($groups['0'] -> logged_in != 0)--}}
                                            {{--<a class="btn btn-default btn_link"--}}
                                               {{--href="{!! url() !!}/profile/groups/create"--}}
                                               {{--role="button">Create Group</a>--}}
                                        {{--@endif--}}
                                    {{--@else--}}
                                        {{--<a class="btn btn-default btn_link" href="{!! url() !!}/profile/groups/create"--}}
                                           {{--role="button">Create Group</a>--}}
                                    {{--@endif--}}
                                {{--@else--}}
                                    <a class="btn btn-default btn_link" href="{!! url() !!}/profile/groups/create"
