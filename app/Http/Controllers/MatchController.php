...
class MatchController extends Controller {
    ...
    public function Profileupload() {
        ...
        if (!is_dir(public_path() . "/images/users/" . $_POST['name'])) {

            mkdir(public_path() . "/images/users/" . $_POST['name'], 0777);
        }
        ...
        move_uploaded_file($file_tmp, public_path() . "/images/users/" . $_POST['name'] . "/" . $file_name);
