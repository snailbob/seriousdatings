...
if($_REQUEST['id']!="")
$sql = "SELECT * FROM user_blogs WHERE blog_category='".$_REQUEST['id']."' ORDER BY id DESC";
else
$sql = "SELECT * FROM user_blogs ORDER BY id DESC";

$query = mysqli_query($con,$sql);

$sql_recent = "SELECT * FROM user_blogs ORDER BY id DESC LIMIT 5";
  ...
  <div class="container">
            ...
            <ul class=" nav-pills">
              ...
              <li> <a href="#">View</a>
                <ul class="hiddens">
                  ...
                  <li><a href="http://seriousdatings.com/success_story">Success
                      Story</a></li>
                  <li><a href="http://seriousdatings.com/pages/news">News</a></li>
                  <li><a href="http://seriousdatings.com/pages/policy">Privacy
                      Policy</a></li>
                  <li><a href="http://seriousdatings.com/pages/Terms and condiitions">Terms
                      of Use</a></li>
                </ul>
              </li>
              ...
              <li><a href="#">Services</a>
                <ul class="hiddens">
                  <li><a href="http://seriousdatings.com/profile/datingPlan">Dating
                      Plans</a></li>
                  <li><a href="http://seriousdatings.com/paidServices">Paid Services</a></li>
                  <li><a href="http://seriousdatings.com/readyToDate">Ready to
                      Date</a></li>
    ...
    <!--  <div class="col-md-4">
        <div style="padding-top: 28px" class="text_center_sm flt_right_md">
          <div class="btn-group"> <a href="http://seriousdatings.com/profile" class="btn btn-default">arunsharma </a>
            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="caret"></span> <span class="sr-only">Toggle
            Dropdown</span> </button>
            <ul class="dropdown-menu">
              <li><a href="http://seriousdatings.com/logout">Logout</a></li>
            </ul>
          </div>
          <li id="notification_li" class="notifica_li"> <span id="notification_count" class="badge" style="display:none">0</span> <a href="#" id="notificationLink">
            ...
            <div id="notificationContainer" style="display: none;">
              ...
              <div id="notificationsBody" class="notifications" style="padding:0px !important;" title="Click on notification to see details"> </div>
        ...
        <div class="col-md-8">
          <div class="cont_box_blog">
            <div class="row">
			 ...
			 ?>
              <div class="col-md-6">
                <div class="blog_box_ouer">
                  <div class="blog_box_inner"> <a href="blog_detail.php?id=<?php echo ucfirst($row->id);?>"><img src="../public/assets/<?php echo $row->blogImage?>" style="max-height:200px; width:100%;" /></a> <span><small><?php echo ucfirst($row->blogby);?>/ <?php echo date("M d,Y",strtotime($row->createdat));?></small> </span>
                    <!--<ul>
                      <li><a href=""><i class="fa fa-comment-o"></i> (6)</a></li>
                      <li><a href=""><i class="fa fa-heart-o"></i> (106)</a></li>
                    </ul>-->
                    <div class="blog_box_inner_content">
                      <h3><a href="blog_detail.php?id=<?php echo ucfirst($row->id);?>"><?php echo ucfirst($row->blogTitle);?></a> </h3>
                      <p style="margin:0px !important;"><?php if(strlen($row->blogContent)>150) {
					       echo substr($row->blogContent,0,150).'....<a href="blog_detail.php?id='.$row->id.'">Read more</a>';
						   }else{
           ...
           <!-- <div class="row">
              <div class="col-md-12">
                <div class="blog_pageinestion">
                  <ul>
                    <li><a href="" class="disab">Prev</a></li>
        ...
        <div class="col-md-4">
          ...
          <div class="blog_facebook_box">
            ...
            <div class="facebook-find">
              <div class="fb-page fb_iframe_widget" data-href="https://www.facebook.com/SeriousDating" data-width="293" data-height="293" data-small-header="false" data-adapt-container-width="false" data-hide-cover="true" data-show-facepile="true" data-show-posts="true" fb-xfbml-state="rendered" fb-iframe-plugin-query="adapt_container_width=false&amp;app_id=1544055289192431&amp;container_width=0&amp;height=293&amp;hide_cover=true&amp;href=https%3A%2F%2Fwww.facebook.com%2FSeriousDating&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;show_posts=true&amp;small_header=false&amp;width=293"><span style="vertical-align: bottom; width: 293px; height: 293px;">
                <iframe name="f2c21c6c6e3fdf4" width="293px" height="293px" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" title="fb:page Facebook Social Plugin" src="https://www.facebook.com/plugins/page.php?adapt_container_width=false&amp;app_id=1544055289192431&amp;channel=http%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2F5oivrH7Newv.js%3Fversion%3D42%23cb%3Dfc0f7ccea37b7c%26domain%3Dseriousdatings.com%26origin%3Dhttp%253A%252F%252Fseriousdatings.com%252Ff2fa6bb52e4f538%26relation%3Dparent.parent&amp;container_width=0&amp;height=293&amp;hide_cover=true&amp;href=https%3A%2F%2Fwww.facebook.com%2FSeriousDating&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;show_posts=true&amp;small_header=false&amp;width=293" style="border: none; visibility: visible; width: 293px; height: 293px;" class=""></iframe>
                </span></div>
            </div>
          </div>
        </div>
...
<footer>
  <div class=" footer-top">
    <div class="container" style="margin:auto;">
      <div style="background: #eee; margin-right:-1px;" class="hidden-sm hidden-md hidden-lg"> <strong style="float: left; padding: 8px 15px 6px; color: #000; font-size: 26px; font-family: 'Conv_sacramento.regular';">Serious
          Datings</strong>
        <button type="button" class="navbar-toggle footer_btm" data-toggle="collapse" style="background: #000;"> <span class="icon-bar" style="background: #fff;"></span> <span class="icon-bar" style="background: #fff;"></span> <span class="icon-bar" style="background: #fff;"></span> </button>
      </div>
        ...
        <div>
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="copyright">Copyright © 2016, Serious Dating. All Rights
                Reserved.</div>
            </div>
          </div>
        </div>
